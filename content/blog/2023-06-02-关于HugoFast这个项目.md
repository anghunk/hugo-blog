...
Github: [https://github.com/ezyshu/HugoFast](https://github.com/ezyshu/HugoFast)  
...
前往 [https://github.com/ezyshu/HugoFast](https://github.com/ezyshu/HugoFast) fork 本项目，然后下载到本地。

```bash
git clone https://github.com/ezyshu/HugoFast.git
```
